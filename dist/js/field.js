...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-accordion-field', __webpack_require__(3));
  Vue.component('detail-nova-accordion-field', __webpack_require__(6));
  Vue.component('form-nova-accordion-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    toggleExpansion: function toggleExpansion(key) {
      if (this.isExpanded(key)) this.expandedGroup.splice(this.expandedGroup.indexOf(key), 1);else this.expandedGroup.push(key);
    }
  },
  computed: {
    ...
    headerTextStyles: function headerTextStyles() {
      return {
  ...
  return _c(
    ...
    _vm._l(_vm.items, function(item, key) {
      return _c(
        ...
        {
          key: item,
          attrs: { title: this.title, description: this.description },
          on: {
            click: function($event) {
              return _vm.toggleExpansion(key)
            }
          }
        },
        [
          _c("div", { style: _vm.headerStyles }, [
            _c(
              "a",
              {
                staticClass: "mb-1 p-4 no-underline flex justify-between",
                style: _vm.headerTextStyles,
                attrs: { href: "#" }
              },
              [
                _c("strong", [_vm._v(_vm._s(item[_vm.title]))]),
                _vm._v(" "),
                !_vm.isExpanded(key) ? _c("span", [_vm._v("➕")]) : _vm._e(),
                _vm._v(" "),
                _vm.isExpanded(key) ? _c("span", [_vm._v("➖")]) : _vm._e()
              ]
            )
            ...
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.isExpanded(key),
                expression: "isExpanded(key)"
              }
            ],
            staticClass: "tab__content p-2",
            domProps: { innerHTML: _vm._s(item[_vm.description]) }
          })
        ]
      )
    }),
